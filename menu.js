...
const MENU = {
  ...
  baseItems: [
    // 期間/数量限定（2025年6月時点・公式サイト掲載中）
    { id: 'the_gyu', category: 'limited', name: 'THE牛カレー', price: 1232, menuId: 1766, img: 'https://www.ichibanya.co.jp/sys/upload/save/46967261969a8ca6910338_370.png', note: '数量限定' },
    { id: 'sasami2', category: 'limited', name: '手仕込ささみカツ(2本)カレー', price: 1190, menuId: 910, img: 'https://www.ichibanya.co.jp/sys/upload/save/150971871969a8caea949ce_370.png', note: '期間限定' },
    { id: 'sakura_ebi', category: 'limited', name: '桜えびとあさりの春野菜カレー', price: 1012, menuId: 1903, img: 'https://www.ichibanya.co.jp/sys/upload/save/41525516669a8cb56decbd_370.png', note: '数量限定' },
    { id: 'bacon_soup', category: 'limited', name: '厚切りベーコンとスモークチーズのスープカレー', price: 1160, menuId: 1872, img: 'https://www.ichibanya.co.jp/sys/upload/save/160928013269a0ed9a33446_370.png', note: '数量限定・ライス付' },
    { id: 'roast_chicken_soup', category: 'limited', name: 'ローストチキンスープカレー', price: 1110, menuId: 801, img: 'https://www.ichibanya.co.jp/sys/upload/save/107654243069a6611b515ca_370.png', note: '期間限定・ライス付' },
    { id: 'base_soup', category: 'limited', name: 'ベーススープカレー', price: 750, menuId: 906, img: 'https://www.ichibanya.co.jp/sys/upload/save/209113053968df773bd5e71_370.png', note: '期間限定・ライス付' },
    { id: 'maru_combo_a_curry', category: 'limited', name: 'マル得コンボA（カレーソース付）', price: 1960, menuId: 1865, img: 'https://www.ichibanya.co.jp/sys/upload/save/839072406692663b747630_370.png', note: 'テイクアウト専用' },
    { id: 'maru_combo_b_curry', category: 'limited', name: 'マル得コンボB（カレーソース付）', price: 2060, menuId: 1868, img: 'https://www.ichibanya.co.jp/sys/upload/save/551481760692663d1a9c14_370.png', note: 'テイクアウト専用' },
    { id: 'maru_combo_c_curry', category: 'limited', name: 'マル得コンボC（カレーソース付）', price: 2370, menuId: 1869, img: 'https://www.ichibanya.co.jp/sys/upload/save/292481593692664021df03_370.png', note: 'テイクアウト専用' },
    // 肉類
